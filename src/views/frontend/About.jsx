        ...
        <div className="story py-5">
          <div className="story-left" data-aos="fade-right">
            ...
            <div className="story-content">
              <p>
                Divine 的名字，來自於一個簡單的信念。
                <br />
                <br />
                <span className="text-big">甜點，應該像一種祝福。</span>
                <br />
                它不只是餐後的點綴，而是一種能讓人停下腳步、感受片刻幸福的存在。
                <br />
                <br />
                在法式甜點文化中，甜點是一門結合藝術與科學的工藝。
                <br />
                精準的比例、嚴謹的技術，與創造力並存。
                <br />
                <br />
                因此，Divine 希望創造的，不只是甜點，
                <br />
                而是一種能讓人記住的體驗。
                <br />
                <br />
        ...
        <div className="art py-5">
          ...
          <div className="section" data-aos="zoom-in-left">
            <div className="img-box">
              <img
                ...
                src="https://plus.unsplash.com/premium_photo-1700612685657-3b039ec2aa11?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDl8fHxlbnwwfHx8fHw%3D"
                alt="泡芙麵糰"
              />
            </div>
            <div className="art-content text-start">
              ...
              <div className="product-slogan">
                <p>
                  ...
                  <br />
                  <br />
                  從麵糊的水分比例、麵糰的溫度、烘烤的時間，
                  <br />
                  到外殼的酥脆與內餡的滑順，都必須達到完美平衡。
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="section-anti" data-aos="zoom-in-right">
            <div className="img-box">
              <img
                className="section-img"
                src="https://media.istockphoto.com/id/2244918697/photo/pistachio-and-pumpkin-christmas-paris-brest-dessert.jpg?s=612x612&w=0&k=20&c=YXtVJQ0HQFk-GA6326cog7t5qaLGF-uTDstB7VA6Xxc="
                alt="泡芙麵糰"
              />
            </div>
          ...
          <div className="section" data-aos="zoom-in-left">
            <div className="img-box">
              <img
                className="section-img"
                src="https://media.istockphoto.com/id/2180189165/photo/exquisite-religieuse-eclair-pastry-with-patissiere-cream-with-chocolate-and-coffee-glaze.jpg?s=612x612&w=0&k=20&c=jJAwU2tokIxQGw1GUhiluOjC2RKOVF1HSqUaLqjQ1_E="
                alt="泡芙麵糰"
              />
            </div>
            <div className="art-content text-start">
          ...
          <div className="section-anti" data-aos="zoom-in-right">
            <div className="img-box">
              <img
                className="section-img"
                src="https://images.unsplash.com/photo-1616534900631-c875e41ab2c8?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8Q3JlYW0lMjBQdWZmfGVufDB8fDB8fHww"
                alt="泡芙麵糰"
              />
            </div>
            <div className="art-content text-end">
          ...
          <div className="section" data-aos="zoom-in-left">
            <div className="img-box">
              <img
                className="section-img"
                src="https://media.gettyimages.com/id/2154012568/fr/photo/chouquettes-with-sugar-pastries.jpg?s=612x612&w=0&k=20&c=YWqnkX_efIHl7jVNwVathcQe5Rtl_DTcX_eI4WzzVgE="
                alt="泡芙麵糰"
              />
            </div>
            <div className="art-content text-start">
          ...
          <div className="section-anti" data-aos="zoom-in-right">
            <div className="img-box">
              <img
                className="section-img"
                src="https://media.gettyimages.com/id/746034619/fr/photo/st-honore-cakes-with-honey.jpg?s=612x612&w=0&k=20&c=hEc-MhzjZm_BKOyo7WjBiNzaagdUS1almOxoYaV7WUM="
                alt="泡芙麵糰"
              />
            </div>
            <div className="art-content text-end">
          ...
          <div className="handmade-content">
            ...
            <div className="role-content">
              <p>
                ...
                <br />
                <br />
                <span className="text-big">所有甜點皆為手工製作。</span>
                <br />
                <br />
                我們不追求大量生產，
                <br />
        ...
        <div className="welcome">
          <div className="welcome-content">
            ...
            <p>
              ...
              <br />
              <br />
              Divine 希望帶來的，不只是甜點本身，
              <br />
              而是一段值得慢慢品味的時刻。
              <br />
              <br />
              如果有一天，你咬下一口泡芙的瞬間感到幸福——
              <br />
              <br />
              那就是 Divine 存在的理由。
            </p>
          ...
          <div className="welcome-title">
            “Precision in Craft, Poetry in Taste.”
          </div>
        </div>
      </div>
    </>
