...
function OrderModal({
  ...
  const delOrder = async (id) => {
    try {
      await axios.delete(
        `${VITE_API_BASE}/api/${VITE_API_PATH}/admin/order/${id}`,
      );
      // console.log(res.data);
      getOrders(currentPage);
      handleCloseModal();
          ...
          <div className="modal-body">
            {modalType === 'del' ? (
              <>
                <p>
                  確定要刪除
                  <span className="text-danger">{modalData.create_at}</span>
                  這筆訂單嗎？
                </p>
              </>
            ) : (
            ...
            {modalType === 'del' ? (
              ...
              <>
                ...
                <button
                  ...
                  onClick={() => updateOrder(modalData.id)}
                >
                  儲存訂單變更
                </button>
              </>
